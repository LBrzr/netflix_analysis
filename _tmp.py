...
plt.savefig("./chart_images/tvshow_year_duration_mean.png")
plt.show()
...
plt.savefig("./chart_images/tvshow_year_count.png")
plt.show()
...
plt.savefig("./chart_images/movie_year_duration_mean.png")
plt.show()
...
plt.savefig("./chart_images/movie_year_count.png")
plt.show()
